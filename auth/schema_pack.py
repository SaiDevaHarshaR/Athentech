...
def schema_hint_for_prompt(allowed_tables: list) -> str:
    ...
    lines = [
        ...
        "the question got abandoned there without ever reaching the right table. The confirmed table "
        "for TAT is trninvlabdet (BILLDATE = sample/order time, CREATEDATE = result time) — go "
        "straight there for any TAT question, don't rely on schema search alone to surface it. When "
